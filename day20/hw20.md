...
Yes, because Datalog can be reduced to propositional logic, which is NP-complete. We can say that Datalog is an implementation of programming in logic (which is also Prolog). 
